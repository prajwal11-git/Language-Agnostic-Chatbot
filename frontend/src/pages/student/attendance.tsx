...
const AttendancePage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header title="Attendance" userInfo={userInfo} />
      <div className="flex">
        <Sidebar items={sidebarItems} />
        <main className="flex-1 p-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-foreground mb-6">Attendance Record</h2>
            <div className="bg-card border border-border rounded-xl p-8 shadow-sm">
              <p className="text-muted-foreground">Attendance details will be displayed here.</p>
            </div>
          </div>
        </main>
      </div>
