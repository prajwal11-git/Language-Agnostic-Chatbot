...
const FeedbackPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Header title="Raise Feedback" userInfo={userInfo} />
      <div className="flex">
        <Sidebar items={sidebarItems} />
        <main className="flex-1 p-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-foreground mb-6">Submit Feedback</h2>
            <div className="bg-card border border-border rounded-xl p-8 shadow-sm">
              <p className="text-muted-foreground">Feedback submission form will be displayed here.</p>
            </div>
          </div>
        </main>
      </div>
